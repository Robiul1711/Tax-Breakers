    ...
    return (
        <div className="min-h-screen auth-bg flex items-center justify-center">
            <div className="md:p-6 rounded-2xl flex items-center justify-center w-full md:w-auto">
                <div className="auth-form-bg shadow-[3px_3px_40px_0px_rgba(0,0,0,0.06)] rounded-2xl w-full md:min-w-xl mx-auto px-6 md:px-10 py-4 ">
                    ...
                    <div className="w-full text-center">
                        ...
                        <h1 className="lg:text-3xl text-2xl font-semibold mb-3 text-gray-800">Create Account</h1>
                        <p className="text-[rgba(145,153,146,1)] lg:text-base text-sm">Sign up to get started.</p>
                    </div>
