...
const StepTen: React.FC = () => {
  ...
  const options: OptionType[] = [
    {
      id: 1,
      label: "I have additional information to share (such as real estate, additional income, cryptocurrencies, or stock options).",
    },
    {
      id: 2,
      label: "I do not have any additional information to share (such as real estate, additional income, cryptocurrencies, or stock options).",
    },
    {
      id: 3,
      label: "I am gathering additional information that may need to be shared.”",
    },
    {
      id: 4,
      label: "This question is not apply to me.",
    },
  ];
