...
const StepFive: React.FC = () => {
  ...
  const options: OptionType[] = [
    {
      id: 1,
      label: "My projected annual turnover exceeds €85,000.",
    },
    {
      id: 2,
      label: "My projected annual turnover does not exceed €85,000.",
    },
    {
      id: 3,
      label: "My projected annual turnover is not yet finalized.",
    },
    {
      id: 4,
