...
const StepSeven: React.FC = () => {
  ...
  const options: OptionType[] = [
    {
      id: 1,
      label: "My activity is primarily directed towards a current or former employer in the previous two years.",
    },
    {
      id: 2,
      label: "My activity is not primarily directed towards a current or former employer in the previous two years.",
    },
    {
      id: 3,
      label: "I am waiting for clarity on whether my activity is directed towards a current or former employer.",
    },
    {
      id: 4,
