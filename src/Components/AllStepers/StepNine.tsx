...
const StepNine: React.FC = () => {
  ...
  const options: OptionType[] = [
    {
      id: 1,
      label: "I have a participation in limited liability companies (SRL, LTD, etc.) where I have direct or indirect control.",
    },
    {
      id: 2,
      label: "I do not have any participation in limited liability companies where I have direct or indirect control.",
    },
    {
      id: 3,
      label: "I am waiting for confirmation of my participation in limited liability companies.",
    },
    {
      id: 4,
