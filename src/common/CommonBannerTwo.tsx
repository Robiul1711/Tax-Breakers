...
const CommonBannerTwo = ({ main_title, description, brandName }: { main_title: string, description: string, brandName?: string }) => {
    return (
        <div style={{
            ...
            <h2 className="text-[#151515] px-4 text-3xl sm:text-[36px] md:text-[48px] lg:text-[56px] xl:text-[64px] font-bold text-center capitalize max-w-[1080px] mx-auto">{main_title}</h2>
            <p className="text-[#677489] px-4 text-center max-w-[1080px] leading-8 text-base sm:text-sm md:text-xl font-medium mx-auto mt-6">
