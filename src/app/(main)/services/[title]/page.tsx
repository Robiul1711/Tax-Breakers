        ...
        <div>
            ...
            <div className="section-padding-x">
                <div className="my-18 lg:my-36">
                    ...
                    <div className="mt-12 flex xl:flex-row lg:flex-col flex-col gap-5 w-full">
                        <div className="xl:w-[40%] flex xl:flex-col lg:flex-row flex-col gap-5">
                            <div className="flex-1 bg-[#FBFBFB] border border-[#E5E5E5] rounded-3xl p-4 lg:p-8">
                        ...
                        <div className="xl:w-[60%] flex xl:flex-col lg:flex-row flex-col gap-5">
                            <div className="flex-1">
                                <Image className="w-full xl:h-[550px] lg:h-[200px] md:h-[300px] h-full  object-cover rounded-[25px]" src={ServiceMeetingImg} alt="Service meeting" width={823} height={456} />
                            </div>
                            <div className="flex-1 gap-5">
                                <div className="bg-[#FBFBFB] border border-[#E5E5E5] rounded-3xl p-4 lg:p-8 h-full">
