...
const ServicesPage = () => {
    return (
        <div>
            ...
            <div className="mt-12 lg:m-8 m-4 flex lg:flex-row flex-col gap-5">
                ...
                <div className="flex-1 flex flex-col gap-5" >
                    <Image className="w-full object-cover" src={IdentityImg2} alt="our identity img" width={730} height={510} />
