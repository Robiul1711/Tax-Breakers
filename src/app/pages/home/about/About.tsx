...
const About = () => {
    return (
        <div className="my-18 lg:my-36">
            ...
            <div className="xl:flex justify-between gap-[25px] mt-12">
                <div className="flex-1">
                    <Image className="w-full xl:h-full lg:h-[400px] md:h-[300px] h-[200px] object-cover rounded-3xl" src={AboutImg} alt="About us" width={725} height={680} />
                </div>
                <div className="flex-1 xl:mt-0 mt-6 bg-[#FBFBFB] border border-[#E5E5E5] rounded-3xl md:p-8 p-4">
                    ...
                    <Title level="title24" children="Why Choose Us" className="mt-4 lg:mt-6 mb-5 lg:mb-8" />
                    <div className="space-y-4">
                        <div className="rounded-[14px] border border-[#E3E8EF] bg-[#FFF] backdrop-blur-[17.5px] flex items-center md:gap-2 gap-4 md:p-5 p-3">
                            <div className="bg-[#BBF49C] md:w-9 w-19 h-9 rounded-full flex justify-center items-center ">
                                <FlashIcon />
                            </div>
                            <h2 className="text-[#515151] md:text-base text-sm"><span className="text-base text-[#0E1109] font-semibold">Expertise You Can Trust - </span> Years of industry experience with proven results.</h2>
                        </div>
                        <div className="rounded-[14px] border border-[#E3E8EF] bg-[#FFF] backdrop-blur-[17.5px] flex items-center md:gap-2 gap-4 md:p-5 p-3">
                            <div className="bg-[#BBF49C] md:w-9 w-19 h-9 rounded-full flex justify-center items-center ">
                                <FlashIcon />
