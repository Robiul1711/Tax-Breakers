            ...
            <div className="flex gap-5 mt-12">
                ...
                <div className="flex-1 flex flex-col gap-5">
                    {blogs.slice(1, 3).map((blog: TBlog, index: number) => (
                        <div key={index} className="p-6 bg-[#FBFBF] border border-[#E5E5E5] rounded-3xl flex gap-6">
                            <Image className="w-full rounded-3xl" src={blog?.thumbnail} alt={blog?.title} width={256} height={271} />
                            <div>
                                <div>
                                    <Title level="title24" children={blog?.title} />
                                    <p className="text-[#56595C] text-[18px] mt-4">{blog.introduction}</p>
