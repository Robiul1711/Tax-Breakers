...
const ComparisonPlan = () => {
    return (
        <div className="my-36">
            ...
            <div className="flex justify-between items-center border-b border-[#E3E8EF] pb-5 px-5 mt-12">
                <h2 className="flex-1 text-[#0E1109] text-lg font-bold">Feature</h2>
                <h2 className="flex-1 text-[#0E1109] text-lg font-bold flex justify-center items-center">Starter</h2>
                <h2 className="flex-1 text-[#0E1109] text-lg font-bold flex justify-center items-center">Pro</h2>
                <h2 className="flex-1 text-[#0E1109] text-lg font-bold flex justify-center items-center">Premium</h2>
            </div>
            <div>

                {
                    comparisonPlanData?.map((plan, index) => (
                        <div key={index} className="flex justify-between items-center border-b border-[#E3E8EF]/50 py-4 hover:bg-[#FAFAFA] px-5 ">
